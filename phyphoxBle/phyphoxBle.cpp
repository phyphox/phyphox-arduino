...
void BleServer::when_connected(const Gap::ConnectionCallbackParams_t *)
{
	//Optional
}
...
void BleServer::transferExp(BleServer* server)
{
	...
	//uint32_t checksum = crc32::update(table, 0, EXPERIMENT, sizeof(EXPERIMENT);
	#ifndef NDEBUG
...
{	
	...
	//deduce length of name to set up payoad correctly. generates warning...fix later
